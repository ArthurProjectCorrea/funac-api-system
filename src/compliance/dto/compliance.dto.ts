...
export class DataRetentionPolicyDto {
  @ApiProperty({
    description: 'Categoria de dados',
  })
  @IsString()
  category: string;
  ...
  @ApiPropertyOptional({
    description: 'Motivo legal para retenção',
  })
  @IsOptional()
  @IsString()
  legalBasis?: string;
...
export class ConsentDto {
  ...
  @ApiProperty({
    description: 'Se o consentimento foi dado',
  })
  @IsString()
  granted: string;
  ...
  @ApiPropertyOptional({
    description: 'Data de revogação do consentimento',
  })
  @IsOptional()
  @IsDateString()
  revokedAt?: string;
